...
#define HAVE_GET_DEFAULT_CONTEXT_WITH_LEVEL 1
...
#define SUPERUSER_PATH "/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/bin/X11"
...
#define USER_PATH "/usr/local/bin:/usr/bin:/bin:/usr/bin/X11:/usr/games"
